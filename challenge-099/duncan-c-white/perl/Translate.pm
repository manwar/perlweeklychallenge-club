...
#
# my $api = FLA($lpos,$island,$name,$l);
#	Produce a F, L or A match of $island (len $l) @ $lpos,
#	storing the result into $name, returning the API.
#
fun FLA( $lpos, $island, $name, $l )
{
	my $str = ( "$lpos" eq "0" ) ?
		"F'$island'" :
		($lpos eq "slen-$l") ?
