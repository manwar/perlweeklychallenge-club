...
#                  raku --optimize=3 test/benchmark-scalabiity.raku --task=task-one --user=rcmlz --max-run-times=1,5,15 --test-before-benchmark=True --out-folder=/tmp nr233; cat /tmp/nr233_task-one.csv
