...
#                  raku --optimize=3 test/benchmark-scalabiity.raku --task=task-two --user=rcmlz --max-run-time=1 --test-before-benchmark=True --out-folder=/tmp nr233; cat /tmp/nr233_task-two.csv
