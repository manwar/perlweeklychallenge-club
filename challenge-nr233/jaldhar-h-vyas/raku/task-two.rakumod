...
# or               raku --optimize=3 -I challenge-nr233 -- test/benchmark-scalability.raku --task=task-two --user=jaldhar-h-vyas --max-run-times=1,3,7 --test-before-benchmark=True --out-folder=/tmp nr233; cat /tmp/nr233_task-two.csv
