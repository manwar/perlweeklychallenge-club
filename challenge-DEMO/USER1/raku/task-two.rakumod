...
# or               raku --optimize=3 -I challenge-DEMO -- test/benchmark-scalability.raku --task=task-two --user=USER1 --max-run-times=1,3,7 --test-before-benchmark=True --out-folder=/tmp DEMO; cat /tmp/DEMO_task-two.csv
