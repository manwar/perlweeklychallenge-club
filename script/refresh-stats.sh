...
fetch-pwc-stats --members members.json --source challenge-017 --current
...
fetch-pwc-stats --members members.json --source challenge-016 --master pwc-summary.json --update
