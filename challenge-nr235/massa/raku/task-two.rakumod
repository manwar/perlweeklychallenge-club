...
# or               raku --optimize=3 -I challenge-nr235 -- test/benchmark-scalability.raku --task=task-two --user=massa --max-run-times=1,3,7 --test-before-benchmark=True --out-folder=/tmp nr235; cat /tmp/nr235_task-two.csv
