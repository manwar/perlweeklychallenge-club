...
# or               raku --optimize=3 test/benchmark-scalabiity.raku --task=task-two --user={{USER}} --max-run-time=1 --test-before-benchmark=True --out-folder=/tmp {{TEMPLATE}}; cat /tmp/{{TEMPLATE}}_task-two.csv
