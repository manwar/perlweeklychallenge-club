...
# or               raku --optimize=3 -I challenge-{{CHALLENGE}} -- test/benchmark-scalability.raku --task=task-one --user={{USER}} --max-run-times=1,3,7 --max-problem=10 --v=True --test-before-benchmark=True --out-folder=/tmp {{CHALLENGE}}; cat /tmp/{{CHALLENGE}}_task-one.csv
