...
func main() {
	for _, data := range []struct {
		...
		io.WriteString(os.Stdout, cmp.Diff(bab(data.input), data.output)) // blank if ok, otherwise show the difference
	}
}
