...
is(Palindrome->is_palindrome(10), '', 'should not be a palindrome');
...
is(Palindrome->is_palindrome(5432154321), '', 'should not be a palindrome');
is(Palindrome->is_palindrome(), '', 'protect against no input');