...
# or               raku --optimize=3 -I challenge-nr234 -- test/benchmark-scalability.raku --task=task-two --user=massa --max-run-times=1,3,7 --test-before-benchmark=True --out-folder=/tmp nr234; cat /tmp/nr234_task-two.csv
